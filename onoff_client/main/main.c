...
void example_ble_mesh_send_gen_onoff_set(void)
{
    ...
    // common.ctx.addr = 0xC000;   /* to Group Address */
    common.ctx.addr = 0x0027;   /* to Unicast Address */
                                               ...
                                               esp_ble_mesh_generic_client_cb_param_t *param)
{
    ...
    case ESP_BLE_MESH_GENERIC_CLIENT_SET_STATE_EVT:
        ...
        break;
    // NOTE: This event is triggered when Client node sended a SET message (SET ACK - opcode 0x8202) to Server node 
    //       at TWO address as Group Address or ALL Group (0xFFFF).
    //       If Client node sended a SET message (SET ACK - opcode 0x8202) to Server node at Unicast Address is
    //       `ESP_BLE_MESH_GENERIC_CLIENT_SET_STATE_EVT` event is triggered
    case ESP_BLE_MESH_GENERIC_CLIENT_PUBLISH_EVT:
        ESP_LOGI(TAG, "ESP_BLE_MESH_GENERIC_CLIENT_PUBLISH_EVT");
        ESP_LOGI(TAG, "STATE Server: onoff %d", param->status_cb.onoff_status.present_onoff);
        break;
    case ESP_BLE_MESH_GENERIC_CLIENT_TIMEOUT_EVT:
        ...
        if (param->params->opcode == ESP_BLE_MESH_MODEL_OP_GEN_ONOFF_SET) {
            ...
            /* If failed to get the response of Generic OnOff Get, resend Generic OnOff Get  */
...
void app_main(void)
{
    ...
    // Set up the device name again.
    // NOTE: This function must be called after `ble_mesh_init()` function.
    bt_mesh_set_device_name("Client Node");
